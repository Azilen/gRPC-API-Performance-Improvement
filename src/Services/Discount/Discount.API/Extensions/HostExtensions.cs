        ...
        public static IHost MigrateDatabase<TContext>(this IHost host, int? retry = 0)
        {
            ...
            using(var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    command.CommandText = "INSERT INTO Coupon(ProductName, Description, Amount) VALUES ('Samsung 10', 'Samung 10 discount', 100);";
                    command.ExecuteNonQuery();
                ...
                {
                    logger.LogError(ex, "An occured while migrating the postgresql database");
